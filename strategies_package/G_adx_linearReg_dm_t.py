...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    adx: pl.Expr = plta.linearreg_angle(plta.adx(timeperiod=lookback), timeperiod=lookback)
    ...
    uptrend_trigger_init: pl.Expr = adx > 0
    downtrend_trigger_init: pl.Expr = adx < 0
