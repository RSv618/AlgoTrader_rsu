...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    threshold: int = int(parameter['threshold'] * lookback)
    ...
    uptrend_trigger_init: pl.Expr = rolling_count > threshold
    downtrend_trigger_init: pl.Expr = lookback - rolling_count > threshold
