...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    adosc: pl.Expr = plta.adosc(fastperiod=lookback//2, slowperiod=lookback)
    uptrend_trigger_init: pl.Expr = (adosc > 0)
    downtrend_trigger_init: pl.Expr = (adosc < 0)
