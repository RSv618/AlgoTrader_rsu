...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    slow_ma: pl.Expr = linear_angle.rolling_mean(lookback)
    uptrend_trigger_init: pl.Expr = linear_angle > slow_ma
    downtrend_trigger_init: pl.Expr = linear_angle < slow_ma
