...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    linear_angle: pl.Expr = plta.linearreg_angle(c, lookback)
    linear_angle_2: pl.Expr = plta.linearreg_angle(linear_angle, lookback)
    uptrend_trigger_init: pl.Expr = linear_angle_2 < threshold
    downtrend_trigger_init: pl.Expr = linear_angle_2 > -threshold
    ...
    df = df.with_columns(
        ...
        linear_regression_angle=linear_angle_2.cast(pl.Float64),
