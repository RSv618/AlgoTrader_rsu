...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    willr = plta.ht_trendline(willr)
    uptrend_trigger_init: pl.Expr = (willr > 100 - threshold)
    downtrend_trigger_init: pl.Expr = (willr < threshold)
