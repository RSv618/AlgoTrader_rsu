...
def indicators(df: pl.DataFrame, parameter: dict[str, Any]) -> pl.DataFrame:
    ...
    uptrend_trigger_init: pl.Expr = (ht_trend < entry_low.shift(1))
    uptrend_exit_trigger_init: pl.Expr = (ht_trend > exit_high.shift(1))
    downtrend_trigger_init: pl.Expr = (ht_trend > entry_high.shift(1))
    downtrend_exit_trigger_init: pl.Expr = (ht_trend < exit_low.shift(1))
